...
public class ValkyrieInputHandler : Singleton<ValkyrieInputHandler>
{
    [Header("InputSystem")]
    ...
    private int _characterControlled = 2;
    ...
    public void UseCredit(InputAction.CallbackContext context)
    {
        ...
        {
            //WHY DOES THIS ALWAYS FIRE A NULL ERROR FOR FIRST PLAYER USING CREDITS?!
